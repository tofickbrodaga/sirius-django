...
from biobaseapp.models import Strains, StrainProcessing
...
class StrainProcessingAPITest(APITestCase):
    def setUp(self):
        ...
        self.strain_processing = StrainProcessing.objects.create(
            strain_id=self.strain,  # Используем правильное имя поля
